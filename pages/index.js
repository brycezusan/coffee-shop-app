  ...
  return (
    ...
    <Layout title={`${categoriaActual?.nombre}`}>
      <div className="w-11/12 mx-auto pt-4 font-bold text-slate-900 space-y-6">
        <h1 className="text-center text-slate-950 font-black text-3xl uppercase antialiased">{categoriaActual?.nombre}</h1>
        <p className="text-slate-900 text-lg">Elige  y personaliza tu pedido.</p>
      </div>
